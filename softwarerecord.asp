...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%if category="T" then response.write "學員補充教材紀錄維護" else if category="S" then response.write "學員自學軟體紀錄維護" else if category="F" then response.write "學員自學紀錄維護" end if%> </TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="news_form" name="news_form" method="post" action="softwarerecord.asp" >
	...
	<%
		...
		sql = sql & "  where   a.signin is not null   "
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR class="inputlabel">
				<TD></TD><TD>預約人</TD><TD>日期</TD><TD>開始時間</TD><TD>結束時間</TD><TD>分鐘</TD><TD>項目</TD><TD></TD><TD></TD>
			</TR>
			<TR class="inputlabel">
				<TD></TD><TD colspan="6"><%if category="S" then response.write "層級/主題" else if category="T" then response.write "使用項目" else if category="F" then response.write "學習內容/紀錄"  end if%> </TD><TD></TD><TD></TD>
			</TR>
			<TR>
				<TD height="1" bgcolor="#000000" colspan="11"></TD>
			</TR>
			...
			<TR bgcolor="<%=vcolor%>">
				...
				<TD>
				<a href="softwarerecordedit.asp?id=<%=rs("id")%>&category=<%=category%>&sender=<%=sender%>"><img border="0" src="/include/lib/images/wri.gif"></a>
				</TD>
				...
				<TD></TD>
				<TD><a href="swrecord.asp?sid=<%=rs("sid")%>&category=<%=category%>&sender=<%=sender%>"><img border="0"  src="images/record.gif"></a></TD>
			</TR>
			<TR bgcolor="<%=vcolor%>">
				<TD></TD><TD colspan="6"><%if category="S" then response.write rs("softwarelevel")  & "&nbsp;/&nbsp;"  & rs("topic") else response.write rs("usageitem") end if%> &nbsp;</TD><TD></TD><TD></TD>
			</TR>
			<TR>
