...
if validate="add" then
	sql = "select * from boo_language where id='"&id&"' "
...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">編輯語言專長</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="form1" name="form1" method="post" action="languageedit.asp" onsubmit="return check_input();">
