...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%if category="L" then response.write "外語學習講座資料維護"  else response.write "處方課程維護"  end if%> </TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR><TD></TD>
				...
				<TD><input  type="submit" value="查詢" class="inputbutton"><input  type="button"  onclick="window.location='lectureadd.asp?category=<%=category%>'" value="新增" class="inputbutton"></TD>
			</TR>
			</form>
			</TABLE>
		</TD>
