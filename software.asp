...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;自學療程軟體項目維護 </TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="news_form" name="news_form" method="post" action="software.asp" >
			...
			<TR><TD></TD>
				...
				<TD><input  type="submit" value="查詢" class="inputbutton"><input  type="button"  onclick="window.location='softwareadd.asp'" value="新增" class="inputbutton"></TD>
			</TR>
			</form>
			</TABLE>
		</TD>
	...
	<%
		...
		sql = "select * from boo_software a where category='S'  "
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR class="inputlabel">
				<TD></TD><TD>層樓</TD><TD>軟體</TD><TD>開放否</TD><TD></TD><TD></TD><TD></TD><TD></TD><TD></TD>
			</TR>
			<TR>
			...
			<TR bgcolor="<%=vcolor%>">
				...
				<TD><a href="softwareedit.asp?id=<%=rs("id")%>&sender=<%=sender%>"><img border="0" src="/include/lib/images/wri.gif"></a></TD>
				<TD><%=rs("floor")%></TD><TD><%=rs("software")%></TD><TD><%=rs("yn")%></TD>
