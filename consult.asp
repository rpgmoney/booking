...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;學員咨商紀錄維護</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="news_form" name="news_form" method="post" action="consult.asp" >
	...
	<%
		...
		sql = sql & " left join boo_consult b on a.id=b.tid  where a.item='諮商'  and  a.signin is not null  "
		if teachername <>"" then
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR bgcolor="<%=vcolor%>">
				<TD>
				<a href="consultedit.asp?id=<%=rs("bookid")%>&sender=<%=sender%>"><img border="0" src="/include/lib/images/wri.gif"></a>
				</TD>
			...
			<TR bgcolor="<%=vcolor%>">
				...
				<TD align="right"><a href="recordprofile.asp?sid=<%=rs("sid")%>&forderid=2&sender=<%=sender%>"><img border="0"  src="images/record.gif"></a></TD>
			</TR>
			<TR>
