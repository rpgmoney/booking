...
if validate="add" then
	sql = "select * from boo_orallevel where topic='"&topic&"' and category='"&category&"' and rank='"&rank&"'"
...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">新增口語題目資料</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="form1" name="form1" method="post" action="oralleveladd.asp" onsubmit="return check_input();">
