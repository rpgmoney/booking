...
if validate="add" then
		sql = "select * from boo_read where tid='"&id&"' "
...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">學員閱讀紀錄維護編輯</TD>
	</TR>
	<TR >
	...
	<TR>
		...
		<TD width="100%" valign="Top">
			<form id="form1" name="form1" method="post" action="readedit.asp"   onsubmit="return check_input();">
