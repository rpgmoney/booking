...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%if category="L" then response.write "外語學習講座學員簽到作業"  else response.write "處方課程學員簽到作業"  end if%> </TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR class="inputlabel"><TD width="20"></TD>
				<TD><%if category="L" then response.write "外語學習講座"  else response.write "處方課程"  end if%>：</TD>
				<TD>預約人學號或姓名：</TD>
				<TD>狀態</TD>
				<TD></TD>
			</TR>
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR class="inputlabel">
				<TD></TD><TD>日期</TD><TD><%if category="L" then response.write "外語學習講座"  else response.write "處方課程"  end if%></TD><TD>開始時間</TD><TD>結束時間</TD><TD></TD><TD>預約人</TD><TD align="right">預約狀態</TD><TD></TD>
			</TR>
			<TR class="inputlabel">
			<TD></TD>
			<TD colspan="10">報到時間</TD>
			</TR>
			<TR>
				<TD height="1" bgcolor="#000000" colspan="11"></TD>
			</TR>
			...
			<TR bgcolor="<%=vcolor%>">
				...
				<TD align="right">&nbsp;&nbsp;<%=replace(replace(rs("yn"),"Y","<font color=""blue"">已報名</font>"),"N","<font color=""red"">取消</font>")%></TD>
				<TD></TD>
			</TR>
			<TR bgcolor="<%=vcolor%>">
				<TD></TD>
				...
				<TD align="right">
				<%if  rs("signin")<>"" then %>
				<input  type="button" value="取消報到" <%if rs("yn")="N" then response.write "disabled" end if%>  onclick="err_record_item('<%=rs("id")%>')"   class="inputbutton"  style='color:FF6600;font-size=9pt' onMouseOver="this.style.color='#FF0000'" onMouseOut="this.style.color='#FF6600'">
				<%else%>
				<input  type="button" value="報到登入" <%if rs("yn")="N" then response.write "disabled" end if%> onclick="signin_record_item('<%=rs("id")%>')" class="inputbutton"  style='color:009900;font-size=9pt' onMouseOver="this.style.color='#00cc00'" onMouseOut="this.style.color='#009900'">
				<%end if%>
				</TD>
			</TR>
			<TR>
