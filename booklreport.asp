...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">處方課程/外語學習講座紀錄</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="form1" name="form1" method="post" action="booklprint.asp" target="new" onsubmit="return check_input();">
			...
			<tr>
					<td>
						<TABLE cellSpacing=0 cellPadding=0 border=0 >
						<TD><input type="checkbox" name="scope" id="scope0" value="C"></TD><TD>處方課程{</TD>
						<TD><input type="checkbox" name="scope" id="scope1" value="L"></TD><TD>外語學習講座</TD>
						<TD>﹝</TD>
