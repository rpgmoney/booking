...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;學員詩歌饒舌紀錄維護</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="news_form" name="news_form" method="post" action="crkp.asp" >
	...
	<%
		...
		sql = sql & " left join boo_crkp b on a.id=b.tid  where a.item='詩歌'  and  a.signin is not null  "
		if teachername <>"" then
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR class="inputlabel">
				<TD></TD><TD width="32%">預約人</TD><TD width="13%">日期</TD><TD width="7%">時段</TD><TD width="17%">節數</TD><TD width="8%">大專英檢</TD><TD width="15%">教師</TD>
			</TR>
			<TR class="inputlabel">
				<TD></TD><TD colspan="2">老師回饋</TD><TD>詩歌</TD><TD>饒舌</TD><TD>歌曲</TD><TD></TD>
			</TR>
			<TR>
				<TD height="1" bgcolor="#000000" colspan="11"></TD>
			</TR>
			...
			<TR bgcolor="<%=vcolor%>">
				<TD>
				<a href="crkpedit.asp?id=<%=rs("bookid")%>&sender=<%=sender%>"><img border="0" src="/include/lib/images/wri.gif"></a>
				</TD>
			...
			<TR bgcolor="<%=vcolor%>">
				<TD></TD><TD colspan="3"><%=rs("feedback")%>&nbsp;</TD>
				<TD>&nbsp;&nbsp;<%=rs("chant")%></TD><TD>&nbsp;&nbsp;<%=rs("rhyme")%></TD><TD>&nbsp;&nbsp;<%=rs("song")%></TD><TD align="right"><a href="recordprofile.asp?sid=<%=rs("sid")%>&forderid=5&sender=<%=sender%>"><img border="0"  src="images/record.gif"></a></TD>
			</TR>
			<TR>
