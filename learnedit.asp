...
if validate="edit" then
	sql = "select * from boo_software where id='"&id&"'  "
...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">編輯補充教材資料</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="form1" name="form1" method="post" action="softwareedit.asp" onsubmit="return check_input();">
