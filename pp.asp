...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;學員簡報練習紀錄維護</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="news_form" name="news_form" method="post" action="pp.asp" >
	...
	<%
		...
		sql = sql & " left join boo_pp b on a.id=b.tid  where a.item='簡報'  and  a.signin is not null  "
		if teachername <>"" then
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR class="inputlabel">
				<TD></TD><TD width="32%">預約人</TD><TD width="13%">日期</TD><TD width="7%">時段</TD><TD width="17%">節數</TD><TD width="8%">大專英檢</TD><TD width="15%">教師</TD><TD ></TD>
			</TR>
			<TR class="inputlabel">
				<TD></TD><TD colspan="2">簡報題目</TD><TD colspan="5">老師回饋</TD>
			</TR>
			<TR>
				<TD height="1" bgcolor="#000000" colspan="11"></TD>
			</TR>
			...
			<TR bgcolor="<%=vcolor%>">
				<TD>
				<a href="ppedit.asp?id=<%=rs("bookid")%>&sender=<%=sender%>"><img border="0" src="/include/lib/images/wri.gif"></a>
				</TD>
				...
				<TD align="right"><a href="recordprofile.asp?sid=<%=rs("sid")%>&forderid=6&sender=<%=sender%>"><img border="0"  src="images/record.gif"></a></TD>
			</TR>
			<TR bgcolor="<%=vcolor%>">
				<TD></TD><TD colspan="2"><%=rs("briefing")%>&nbsp;</TD>
				<TD colspan="5"><%=rs("feedback")%></TD>
			</TR>
			<TR>
