...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">小老師總統計</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="form1" name="form1" method="post" action="steacherprint.asp" target="new" onsubmit="return check_input();">
			<input type="hidden" value="add" name="validate">
			<input type="hidden" id="nextrec" name="nextrec">
			<TR><TD>
				<TABLE cellSpacing=0 cellPadding=0  border=0 >
					<TR class="inputlabel">
						<TD>學年學期：</TD><TD>使用日期起迄：</TD>
					</TR>
					<TR>
						<TD>
						<select name="yms" class="inputtext">
						<option value=""> - 請指定 -</option>
						<%=YmsOption(94,Year(dateadd("m",-6,date()))-1911,par_yms)%>
						</select>
						</TD>
						<TD>
						<TABLE cellSpacing=0 cellPadding=0 border=0 >
