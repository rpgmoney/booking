...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;語言專長維護 </TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="news_form" name="news_form" method="post" action="language.asp" >
			...
			<TR><TD></TD>
				...
				<TD><input  type="submit" value="查詢" class="inputbutton"><input  type="button"  onclick="window.location='languageadd.asp'" value="新增" class="inputbutton"></TD>
			</TR>
			</form>
			</TABLE>
		</TD>
	...
	<%
		...
		sql = "select * from boo_language a where 1=1  "
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR class="inputlabel">
				<TD></TD><TD>專長代號</TD><TD>專長名稱</TD><TD>開放否</TD><TD>代表色</TD><TD></TD><TD></TD><TD></TD><TD></TD>
			</TR>
			<TR>
				<TD height="1" bgcolor="#000000" colspan="11"></TD>
			</TR>
			...
			<TR bgcolor="<%=vcolor%>">
				...
				<TD><a href="languageedit.asp?id=<%=rs("id")%>&sender=<%=sender%>"><img border="0" src="/include/lib/images/wri.gif"></a></TD><TD><%=rs("code")%></TD><TD><%=rs("name")%></TD><TD><%=rs("yn")%></TD><TD><font color="<%=rs("showcolor")%>">■</font></TD><TD></TD><TD></TD><TD></TD>
			</TR>
			<TR>
