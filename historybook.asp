...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center"><%if category="T" then response.write "加入學員歷史預約紀錄（老師療程）" else response.write "預約小老師輔導療程" end if%></TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<TR id="area_item" style="DISPLAY:<%if category="T"  then response.write "block" else response.write "none" end if %>"><TD>
				<TABLE cellSpacing=0 cellPadding=0  border=0 >
					<TR class="inputlabel">
						<TD>預約項目：<font color="#FF0000">※預約項目不受處方籤控制</font></TD>
					</TR>
					<TR>
						<TD>
							<TABLE cellSpacing=0 cellPadding=0  border=0 >
							<TR>
							<TD><input type="radio" name="item" id="item0" onclick="clickblock('0');" class="inputtext" value="" <%if item="" or isnull(item) or isempty(item) then response.write "checked" end if%> ></TD><TD >未指定</TD>
							<TD><input type="radio" name="item" id="item1" onclick="clickblock('1');" class="inputtext" value="診斷" <%if item="診斷" then response.write "checked" end if%> ></TD><TD >診斷</TD>
							<TD><input type="radio" name="item" id="item2" onclick="clickblock('2');" class="inputtext" value="諮商" <%if item="諮商" then response.write "checked" end if%>></TD><TD >諮商</TD>
							<TD><input type="radio" name="item" id="item3" onclick="clickblock('3');" class="inputtext" value="口語" <%if item="口語" then response.write "checked" end if%>></TD><TD >口語</TD>
							<TD><input type="radio" name="item" id="item4" onclick="clickblock('4');" class="inputtext" value="簡報" <%if item="簡報" then response.write "checked" end if%>></TD><TD >簡報</TD>
							<TD><input type="radio" name="item" id="item5" onclick="clickblock('5');" class="inputtext" value="詩歌" <%if item="詩歌" then response.write "checked" end if%>></TD><TD >詩歌</TD>
							<TD><input type="radio" name="item" id="item6" onclick="clickblock('6');" class="inputtext" value="寫作" <%if item="寫作" then response.write "checked" end if%>></TD><TD >寫作</TD>
							</TR>
							</TABLE>
						</TD>
					</TR>
