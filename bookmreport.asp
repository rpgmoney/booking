...
<!-- ---------------------------------------------------------------------------------------- -->
	...
	<TR >
		<TD WIDTH="5" height="20"></TD><TD class="T3" valign="center">教師/小老師輔導療程紀錄</TD>
	</TR>
	<TR >
	...
	<TR>
		<TD></TD><TD valign="top">
			...
			<form id="form1" name="form1" method="post" action="bookmprint.asp" target="new" onsubmit="return check_input();">
			...
			<tr>
					<td>
						<TABLE cellSpacing=0 cellPadding=0 border=0 >
						<TD><input type="checkbox" name="scope" id="scope0" value="T"></TD><TD>教師輔導療程</TD>
						<TD><input type="checkbox" name="scope" id="scope1" value="ST"></TD><TD>小老師</TD>
